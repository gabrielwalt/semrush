...
- When reopening, the shared-block ripple still applies: a change to a shared tool affects every page using it — verify those too. Load `draft-unfreeze-page` for the full reopen protocol (when it exists).
